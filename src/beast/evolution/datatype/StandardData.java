...
public class StandardData extends DataType.Base {
    ...
    public Input<Integer> maxNrOrStatesInput = new Input<Integer>("nrOfStates", "specifies the number of character " +
            "states in sites to be filtered", Input.Validate.REQUIRED);
